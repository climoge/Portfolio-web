...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('db649126376.db.1and1.com', 'dbo649126376', 'RedOxBDD@71', 'db649126376', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbhost' => 'db649126376.db.1and1.com',
            'dbal.dbuser' => 'dbo649126376',
            'dbal.dbpasswd' => 'RedOxBDD@71',
            'dbal.dbname' => 'db649126376',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
