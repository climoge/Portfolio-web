...
class __TwigTemplate_eea48a9f534291b81dbb516c0a89cf33fa01eb65c00899ac0d511332a917bd3a extends Twig_Template
{
...
/* <!-- BEGIN text -->*/
/* 	<textarea name="{text.FIELD_IDENT}" class="form-control" id="{text.FIELD_IDENT}" rows="{text.FIELD_ROWS}" cols="{text.FIELD_COLS}">{text.FIELD_VALUE}</textarea>*/
/* <!-- END text -->*/
/* */
